...
WebUI.setText(findTestObject('Object Repository/Page_Instagram/input_Password_password'), 'michaelsetiawanganteng')

WebUI.verifyElementNotVisible(findTestObject('Page_Instagram/div_No results found'))
